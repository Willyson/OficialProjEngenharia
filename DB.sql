...
=======
>>>>>>> ada64fd799d1b7fbbb6298ec3818f478c2b6e81f
-- =======================
-- TABELA TIPO_CONTA
-- =======================
...
<<<<<<< HEAD
=======
CREATE VIEW VW_CONSULTA_IMPORTACOES 
AS
 SELECT
    ...
    ,CASE 
        ...
        ELSE ''
    END AS RETORNO
    ,DATE_FORMAT(DATA_IMPORTACAO, '%d/%m/%Y %H:%i:%s') AS DATA_IMPORTACAO
FROM IMPORTACAO I
INNER JOIN LOG_CONSULTA_ENDERECO L ON (I.ID_IMPORTACAO = L.ID_IMPORTACAO)
ORDER BY DATA_CONSULTA DESC;
